module sui_inscription::time_util {
    ...
    public fun elapsed_time_in_round(genesis_timestamp: u64, timestamp: u64): u64 {
        let diff = timestamp - genesis_timestamp;
        diff % TEN_MINUTES_IN_MILLISECONDS
    }

    public fun is_in_first_half_of_round(genesis_timestamp: u64, timestamp: u64): bool {
        let diff = timestamp - genesis_timestamp;
        diff % TEN_MINUTES_IN_MILLISECONDS < TEN_MINUTES_IN_MILLISECONDS / 2
    }
}