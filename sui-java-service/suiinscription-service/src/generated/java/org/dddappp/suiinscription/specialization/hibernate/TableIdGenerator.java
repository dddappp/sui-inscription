package org.dddappp.suiinscription.specialization.hibernate;
...
public class TableIdGenerator<TCommand, TState> implements IdGenerator<Long, TCommand, TState> {
    ...
    private static final String DEFAULT_ROOT_ENTITY_NAME = "org.dddappp.suiinscription.tool.hibernate.Hello";
