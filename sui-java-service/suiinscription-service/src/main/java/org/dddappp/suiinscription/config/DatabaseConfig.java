...
import org.dddappp.suiinscription.specialization.NullReadOnlyProxyGenerator;
...
//    }
    ...
    public LocalSessionFactoryBean hibernateSessionFactory() throws IOException {
        ...
        sessionFactory.setPackagesToScan("org.dddappp.suiinscription.*"); //add annotation mappings
