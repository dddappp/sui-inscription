...
public class SlotEventId implements Serializable {
    ...
    public SlotEventId(Integer slotNumber, BigInteger version)
    {
        this.slotNumber = slotNumber;
        this.version = version;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        SlotEventId other = (SlotEventId)obj;
        return true 
            && (slotNumber == other.slotNumber || (slotNumber != null && slotNumber.equals(other.slotNumber)))
    ...
    public int hashCode()
    {
        ...
        if (this.slotNumber != null) {
            hash += 13 * this.slotNumber.hashCode();
        }
